...
class NotabeliController extends Controller
{
    ...
    public function beliProdukBaru(Request $request)
    {
        ...
        $batch = Produkbatches::create([
            ...
            'tgl_produksi' => $request->tgl_produksi ?? null,
    ...
    public function addToCart(Request $request)
    {
        ...
        if ($request->input('tgl_produksi') == date('d-m-Y')) {
            $tgl_produksi = null;
        } else {
            $tgl_produksi = $request->input('tgl_produksi') ?: null;
        }
