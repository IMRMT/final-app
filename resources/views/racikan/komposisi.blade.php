...
@section('content')
    ...
    <form method="GET" action="{{ route('racikans.komposisi', ['id' => $komposisi->id]) }}" class="mb-3">
                        ...
                        <td>
                            <form method="POST"
                                ...
                                <input type="submit" value="Delete" class="btn btn-danger"
                                    onclick="return confirm('Are you sure to delete {{ $d->nama_produk }} from this racikan?');">
                            </form>
                        </td>
                    </tr>
                @endforeach
