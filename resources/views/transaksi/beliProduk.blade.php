            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Mohon pilih input yang diinginkan.</small>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Mohon isikan dengan input yang diinginkan.</small>
                    </div>
                </div>
        ...
        @foreach ($prod as $p)
            ...
            <div class="border p-4 rounded mb-4">
                ...
                <form method="POST" action="{{ route('notabelis.cart') }}">
                    ...
                    <div class="form-group">
                        <label for="tgl_produksi">Tanggal Produksi</label>
                        <input type="date" class="form-control" name="tgl_ktgl_produksiadaluarsa"
                            value="{{ old('tgl_produksi', '') }}">
                    </div>
